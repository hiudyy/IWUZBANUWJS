  ...
  try {
    ...
    if (isSpotifyUrl) {
      ...
      const tags = {
        ...
        mimetype: 'image/jpeg',
        copyright: 'Copyright hiudy ©2024',
      };
    ...
    console.error(error);
    throw 'Erro ao obter a rota da musica.';
  }
}
...
async function spotifySearch1(input) {
  try {
    ...
    console.error(error);
    throw 'Erro ao obter os dados da musica.';
  }
}
...
async function spotifySearch2(text) {
  try {
    ...
    console.error(error);
    throw 'Erro na busca no spotify.';
  }
}
